...
//- END THE PLUGIN FROM HERE !!
	...
	$.fn.extend({
		...
		function addNewLightBoxItem(item,opt,direction) {
			...
			var isSold = item.find(opt.sold).html();
			if (isSold) infofield.append('<div class="'+opt.style+' sold">'+isSold+'</div>');
			...
			// TOUCH ENABLED SCROLL
				...
				lboxitem.swipe( {data:lboxitem,
								...
								excludedElements:".hover-more-sign, .hover-blog-link-sign .thumbnails, .closebutton",
